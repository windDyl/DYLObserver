...
/**
 ...
 Block to be executed when the value on specified key-path changes. This value must not be `nil`.
 */
//- (void)dyl_observeObject:(id)object property:(NSString *)keyPath withBlock:(DYLBlockForeignChange)block;

/// Calls `-observeObject:property:withBlock:` for each property.
- (void)dyl_observeObject:(id)object properties:(NSArray *)keyPaths withBlock:(DYLBlockForeignChangeMany)block;
...
- (void)dyl_observeObject:(id)object property:(NSString *)keyPath withSelector:(SEL)selector;
 ...
 */
- (void)dyl_map:(NSString *)sourceKeyPath to:(NSString *)destinationKeyPath transform:(id (^)(id value))transformationBlock;
